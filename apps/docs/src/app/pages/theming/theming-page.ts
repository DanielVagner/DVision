...
export class ThemingPage {
  readonly colorGroups: ColorToken[] = [
    {
      label: 'Primary',
      base: '--dvision-primary',
      hover: '--dvision-primary-hover',
      subtle: '--dvision-primary-subtle',
      text: '--dvision-primary-text',
    },
    {
      label: 'Secondary',
      base: '--dvision-secondary',
      hover: '--dvision-secondary-hover',
      subtle: '--dvision-secondary-subtle',
      text: '--dvision-secondary-text',
    },
    {
      label: 'Accent',
      base: '--dvision-accent',
      hover: '--dvision-accent-hover',
      subtle: '--dvision-accent-subtle',
      text: '--dvision-accent-text',
    },
    {
      label: 'Success',
      base: '--dvision-success',
      hover: '--dvision-success-hover',
      subtle: '--dvision-success-subtle',
      text: '--dvision-success-text',
    },
    {
      label: 'Warning',
      base: '--dvision-warning',
      hover: '--dvision-warning-hover',
      subtle: '--dvision-warning-subtle',
      text: '--dvision-warning-text',
    },
    {
      label: 'Danger',
      base: '--dvision-danger',
      hover: '--dvision-danger-hover',
      subtle: '--dvision-danger-subtle',
      text: '--dvision-danger-text',
    },
    {
      label: 'Info',
      base: '--dvision-info',
      hover: '--dvision-info-hover',
      subtle: '--dvision-info-subtle',
      text: '--dvision-info-text',
    },
  ];
